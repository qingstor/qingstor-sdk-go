...
var _ config.Config
    ...
    type GetBucketNotificationOutput struct {
        ...
        RequestID *string `location:"requestID"`
            ...
            Notifications []*NotificationsType `json:"notifications,omitempty" name:"notifications" location:"elements"` 
    ...
    // PutNotificationRequest creates request and output object of PutBucketNotification.
        ...
        type PutBucketNotificationInput struct {
                // Bucket Notifications
            Notifications []*NotificationsType `json:"notifications" name:"notifications" location:"elements"` // Required
