...
// Bucket name
    ...
    // NotificationsType presents Notifications.
    ...
    // Validate validates the Notifications.
    func (v *NotificationsType) Validate() error {
                    ...
                    if v.Cloudfunc != nil {
                        cloudfuncValidValues := []string{"create_object", "delete_object", "abort_multipart"}
